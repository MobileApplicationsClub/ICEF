...
public class Adapter_Main extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Adapter_Main(Context context) {
        ...
        list.add(new MainList("TIMELINE", "", R.drawable.timeline, ICEF_HelperClass.MAIN_TIMELINE));
        list.add(new MainList("SPEAKERS", "", R.drawable.mic1, ICEF_HelperClass.MAIN_SPEAKERS));
        list.add(new MainList("PARTICIPANTS", "", R.drawable.parti, ICEF_HelperClass.PARTICIPANTS));
        list.add(new MainList("EATERIES", "", R.drawable.eateries, ICEF_HelperClass.EATERIES));
       // list.add(new MainList("FAQ", "", R.drawable.siri, FAQ));
        list.add(new MainList("MEMORIES", "", R.drawable.admissions, ICEF_HelperClass.GALLERY));
        list.add(new MainList("Book Of Abstracts", "", R.drawable.oldbooks, ICEF_HelperClass.BOOK));
