...
import bits.mac.icef_2018.Adapters.Adapter_Contacts;
        ...
        mContacts.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    bits.mac.icef_2018.Lists.ContactList newItem = snapshot.getValue(bits.mac.icef_2018.Lists.ContactList.class);
